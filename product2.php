...
<div class="container-fluid bg-grey">
  <div class="row">
    <div class="col-sm-4">
      <span class="logo"><img src="https://images-na.ssl-images-amazon.com/images/I/613pf1JTs9L._SL1000_.jpg" width="100%"></span>
    </div>
    <div class="col-sm-8">
    &nbsp;&nbsp;
   
     <center> <strong><h2>Nikon D7500 20.9MP Digital SLR Camera (Black) with AF-S DX NIKKOR 18-140mm f/3.5-5.6G ED VR Lens</strong></h2>
      <h3 style=" text-decoration-line: line-through; ">M.R.P.:	₹ 94,950.00
<br></h3>
<h3>Price:	₹ 78,999.00<br>
You Save:	₹ 15,951.00 (17%)<br>
Inclusive of all taxes</h3> 
<input type='hidden' name='product_id' value='85'>
      <input type='hidden' name='product_price' value='15951'>
