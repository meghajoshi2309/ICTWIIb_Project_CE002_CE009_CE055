...
<body>
    ...
    <div class="container">
        <div class="row text-center py-5">
            <?php 
               $sql="SELECT * FROM `producttb` WHERE `categories`='tv'";
               $con=mysqli_connect("localhost","root","","productdb");
               $result=mysqli_query($con,$sql);
...
<div class="w3-content w3-section" style="max-width:1000px">
  <img class="mySlides" src="./images/sl7.png" style="width:200%;">
  <img class="mySlides" src="./images/sl8.png" style="width:200%;">
  <img class="mySlides" src="./images/sl9.png" style="width:200%;">
</div>
