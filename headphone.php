...
<body>
    ...
    <!-- <h1>Welcome to Shoping Cart</h1> -->
    <div class="container">
    <div class="row text-center py-5">
        
    <?php
        $sql="SELECT * FROM `producttb` WHERE `categories`='headphone'";
        $con=mysqli_connect("localhost","root","","productdb");
        $result=mysqli_query($con,$sql);
    ...
    <a href="camera.php"><img class="mySlides" src="./images/exploarcamara.png" style="width:100%"></a>
    <a href="watch.php"><img class="mySlides" src="./images/exploarwatch.png" style="width:100%"></a>
    <a href="mobile.php"><img class="mySlides" src="./images/exploarmobile.png" style="width:100%"></a>
